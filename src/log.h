...
#define warning(x, ...) debug_printf("WARNING", true, text_colors[TEXTCOLOR_YELLOW], (x), __VA_ARGS__)
...
#define glitch(x, ...) debug_printf("GLITCH", true, text_colors[TEXTCOLOR_GRAY], (x), __VA_ARGS__)
