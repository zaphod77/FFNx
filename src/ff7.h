...
struct ff7_externals
{
	...
	int (*sub_7540F6)();
	int (*sub_74D319)();
	void (*world_submit_draw_cloud_754493)(world_texture_data *);

	world_texture_data* clouds_graphics_data_array_E2A370;
	int* dword_E2BBA4;
	int* dword_E28F20;
	unsigned int* world_viewport_x_E2C424;
	unsigned int* world_viewport_y_E2C428;
	...
	void (*world_copy_position_maybe_75042B)(vector4<int>* a1);
