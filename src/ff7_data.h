...
void ff7_find_externals(struct ff7_game_obj* game_object)
{
	...
	ff7_externals.sub_74CBC2 = (int (*)())get_relative_call(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x18);
	ff7_externals.sub_74D4ED = (int (*)())get_relative_call(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x2A);
	ff7_externals.sub_7540F6 = (int (*)())get_relative_call(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x48);
	ff7_externals.sub_74D319 = (int (*)())get_relative_call(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x232);
	ff7_externals.world_submit_draw_cloud_754493 = (void (*)(world_texture_data *))get_relative_call(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x385);
	
	ff7_externals.clouds_graphics_data_array_E2A370 = (world_texture_data*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x14);
	ff7_externals.dword_E2BBA4 = (int*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x64);
	ff7_externals.dword_E28F20 = (int*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0xC5);
	ff7_externals.world_viewport_x_E2C424 = (unsigned int*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x5A5);
	ff7_externals.world_viewport_y_E2C428 = (unsigned int*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x5B0);
	...
	ff7_externals.word_969B98 = (int*)get_absolute_value(ff7_externals.world_submit_draw_clouds_and_meteor_7547A6, 0x5CB);
	//-----
	...
	ff7_externals.world_copy_position_maybe_75042B = (void (*)(vector4<int>* a1))get_relative_call(ff7_externals.world_sub_75C0FD, 0x52);
